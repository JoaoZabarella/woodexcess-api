...
public record AddressRequest(
        @NotBlank(message = "Street is required") @Size(min = 3, max = 255, message = "Street must be between 3 and 255 characters") String street,
        ...
        @NotBlank(message = "State is required") @Size(min = 2, max = 2, message = "State must be exactly 2 characters (UF)") @Pattern(regexp = "^[A-Z]{2}$", message = "State must be a valid Brazilian UF (e.g., SP, RJ)") String state,
