...
public class MaterialListingController {
    ...
    public ResponseEntity<ListingResponse> createListing(
        ...
        ListingResponse response = listingService.createListing(request, userDetails.getId());
    ...
    public ResponseEntity<ListingResponse> updateListing(
        ...
        ListingResponse response = listingService.updateListing(id, request, userDetails.getId());
    ...
    public ResponseEntity<Void> deactivateListing(
        ...
        log.info("PATCH /api/listings/{}/deactivate - User: {}", id, userDetails.getUsername());

        listingService.deactivateListing(id, userDetails.getId());
