...
public class ListingImageControllerIntegrationTest {
        ...
        void setUp() throws Exception {
                ...
                when(s3StorageService.upload(any(), anyString()))
                                .thenAnswer(invocation -> "s3-key-" + UUID.randomUUID());
        ...
        private byte[] createValidImageBytes() {
                // 1x1 pixel PNG image (Base64 decoded)
        ...
        void shouldSetPrimaryImage() throws Exception {
                ...
                MockMultipartFile file1 = new MockMultipartFile("file", "img1.jpg", MediaType.IMAGE_JPEG_VALUE,
                                validImageBytes);
                MockMultipartFile file2 = new MockMultipartFile("file", "img2.jpg", MediaType.IMAGE_JPEG_VALUE,
                                validImageBytes);
        ...
        void shouldReorderImagesSuccessfully() throws Exception {
                ...
                MockMultipartFile file2 = new MockMultipartFile("file", "img2.jpg", MediaType.IMAGE_JPEG_VALUE,
                                validImageBytes);
                MockMultipartFile file3 = new MockMultipartFile("file", "img3.jpg", MediaType.IMAGE_JPEG_VALUE,
                                validImageBytes);
