...
class MaterialListingServiceTest {
        ...
        void shouldCreateListingSuccessfully() {
                ...
                assertThat(result.getTitle()).isEqualTo("Sobra de Madeira");
        ...
        void shouldGetAllListingsWithFiltersSuccessfully() {
                ...
                when(listingRepository.findByFilters(
                                eq(ListingStatus.ACTIVE.name()),
                                eq(MaterialType.WOOD.name()),
                                eq("São Paulo"),
                                isNull(),
                                eq(new BigDecimal("100.00")),
                                eq(new BigDecimal("200.00")),
                                isNull(),
                                eq(pageable))).thenReturn(listingPage);
                ...
                assertThat(result.getContent().get(0).getId()).isEqualTo(listing.getId());
        }
